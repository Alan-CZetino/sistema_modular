...
namespace sistema_modular_cafe_majada.views
{
    public partial class form_opcSalida : Form
    {
        ...
        private void dtg_opcSalida_CellPainting(object sender, DataGridViewCellPaintingEventArgs e)
        {
            //auto ajustar el contenido de los datos al área establecido para el datagrid
            dtg_opcSalida.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dtg_opcSalida.BorderStyle = BorderStyle.None;

            //configuracion de la fila de encabezado en el datagrid
            Font customFonten = new Font("Oswald", 9f, FontStyle.Bold);
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.BackColor = Color.FromArgb(184, 89, 89);
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.Font = customFonten;
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.ForeColor = Color.White;
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.FromArgb(184, 89, 89);
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.SelectionForeColor = Color.White;
            dtg_opcSalida.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;

            //configuracion de las filas por defecto en el datagrid
            Font customFontdef = new Font("Oswald Light", 10.2f, FontStyle.Regular);

            dtg_opcSalida.DefaultCellStyle.BackColor = Color.White;
            dtg_opcSalida.DefaultCellStyle.Font = customFontdef;
            dtg_opcSalida.DefaultCellStyle.ForeColor = Color.Black;
            dtg_opcSalida.DefaultCellStyle.SelectionBackColor = Color.White;
            dtg_opcSalida.DefaultCellStyle.SelectionForeColor = Color.Black;
            dtg_opcSalida.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;

            //configuracion de las filas que son seleccionadas
            dtg_opcSalida.RowsDefaultCellStyle.SelectionBackColor = Color.FromArgb(255, 199, 199);
            dtg_opcSalida.RowsDefaultCellStyle.SelectionForeColor = Color.Black;
        }
